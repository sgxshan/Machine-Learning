...
plt.subplot(2,1,1)
train_loss, test_loss,train_acc, test_acc = runGraph(500,0.05,0.01)
plt.plot(train_loss,label = 'Train set')
plt.plot(test_loss,label = 'Test set')
plt.title('Cross Entropy Loss Versus Updating Numbers (AdamOptimizer)')
...
plt.title('Classification Accuracy Versus Updating Numbers (AdamOptimizer)')
